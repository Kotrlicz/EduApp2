      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-primary-glow/20 to-accent-light/30 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* Main heading */}
            <h1 className="fade-in-up text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 leading-tight">
              Dědkův{" "}
              <span className="text-gradient">Rychlokurz</span>
            </h1>

            {/* Subtitle */}
            <p className="fade-in-delayed text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
                    Jsi ready dát angličtině šanci? Pak jsi na správném místě!
            </p>

            {/* Feature highlights */}
            <div className="fade-in-delayed grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12 max-w-3xl mx-auto px-4">
            ...
            {/* CTA Button */}
            <div className="fade-in-delayed px-4">
              <button 
                onClick={handleStart}
                className="hero-button group w-full sm:w-auto"
              >
            ...
            {/* Bottom text */}
            <p className="fade-in-delayed text-sm text-muted-foreground mt-6 md:mt-8 px-4">
